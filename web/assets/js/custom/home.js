$(document).ready(function(){
	...
	var ias = jQuery.ias({
		...
		pagination: '#timeline .pagination',//Los controles de paginacion van a estar dentro de la clase .pagination
		next: '#timeline .pagination .next_link',//Va a hacer una peticion a ajax para cargar la siguiente pag utilizando la url que esta dentro de ese selector
